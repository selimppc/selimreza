...
<head>
    ...
    <link href="{{ URL::asset('assets/css/theme-default/bootstrap.css?1422792965') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/css/theme-default/materialadmin.css?1425466319') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/css/theme-default/font-awesome.min.css?1422529194') }}" rel="stylesheet" type="text/css" >



    <link href="{{ URL::asset('assets/css/theme-default/font-awesome.min.css?1422529194') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/css/theme-default/material-design-iconic-font.min.css?1421434286') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/css/theme-default/libs/rickshaw/rickshaw.css?1422792967') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/css/theme-default/libs/morris/morris.core.css?1420463396') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/') }}" rel="stylesheet" type="text/css" >
    <link href="{{ URL::asset('assets/') }}" rel="stylesheet" type="text/css" >
